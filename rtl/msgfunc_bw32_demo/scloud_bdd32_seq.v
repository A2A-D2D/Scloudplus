...
/*
 * Sequential BW32 BDD using two reusable BW16 engines.
 *
 * The two child engines first solve y_l/y_r, then are reused for z_a/z_b.
 * This follows the fast-scloud+ direction of moving recursive BDD layers into
 * REG&ALU-style phases instead of instantiating the full recursion tree.
 */
