...
module tb_scloud_bdd16_seq;

    localparam Q_WIDTH = 10;
    localparam TAU     = 2;
    localparam COORDS  = 16;
    ...
    initial begin
        ...
        run_case("pattern", 160'h197f60337d1ff8c1b3cd0b34d2b7e605bad13f6c);

        if (error_count == 0) begin
            $display("TB_PASS scloud_bdd16_seq cases=%0d", case_count);
        end else begin
            $display("TB_FAIL scloud_bdd16_seq errors=%0d cases=%0d",
