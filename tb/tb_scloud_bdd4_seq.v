...
module tb_scloud_bdd4_seq;
    ...
    initial begin
        ...
        run_case("pattern", 40'h8c1b3cd0b3);

        if (error_count == 0) begin
            $display("TB_PASS scloud_bdd4_seq cases=%0d", case_count);
        end else begin
            $display("TB_FAIL scloud_bdd4_seq errors=%0d cases=%0d",
