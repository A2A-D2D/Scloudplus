...
module tb_scloud_bdd_distance_pair_pipe;
    ...
    initial begin
        ...
        if (error_count == 0)
            $display("TB_PASS scloud_bdd_distance_pair_pipe random=200 ties=2");
        else
            $display("TB_FAIL scloud_bdd_distance_pair_pipe errors=%0d",
                     error_count);
        $finish;
    end
